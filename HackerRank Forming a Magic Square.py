...
#     Magic Squares are computed by forming all possible lists in which the 9 elements are in range 1 to 9, sum of all rows, columns and
    ...
    #The output of List Comprehension on line 4 and 5 is hardcoded on line 10 and 11 as interpreting the List Comprehension takes much time and is not accepted by HackerRank
